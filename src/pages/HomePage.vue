      ...
      <div class="container">
        <div class="text-center max-w-4xl mx-auto">
          ...
          <p class="text-xl text-gray-600 mb-8">
            Welcome to the Library of Things - where communities share resources and build connections through the things we own.
          </p>
    ...
    <section class="py-16 bg-white">
      <div class="container">
        <div class="text-center mb-12">
          ...
          <p class="text-lg text-gray-600">Discover amazing items across different categories</p>
        </div>
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          >
            <div class="bg-gray-100 rounded-full p-6 mb-4 group-hover:bg-primary-100 transition-colors">
              <component :is="category.icon" class="h-12 w-12 mx-auto text-gray-600 group-hover:text-primary-600 transition-colors" />
            </div>
      ...
      <div class="container">
        ...
        <div v-else-if="itemsStore.error" class="text-center py-12">
          <div class="bg-error-50 text-error-600 p-6 rounded-lg max-w-md mx-auto">
            ...
            <button @click="loadItems" class="btn-primary mt-4">Try Again</button>
          </div>
        </div>

        <!-- Items Grid -->
        <div v-else-if="displayedItems.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          <div
          ...
          >
            ...
            <div class="flex items-center justify-between">
              <span class="inline-block bg-primary-100 text-primary-800 text-xs font-medium px-2.5 py-0.5 rounded">
        ...
        <div v-else class="text-center py-12">
          ...
          <p class="text-gray-600 mb-6">
            {{ selectedCategory ? 'No items in this category yet.' : 'Be the first to share an item!' }}
          </p>
          <router-link
...
const displayedItems = computed(() => {
  ...
  return itemsStore.items.filter(item => item.category === selectedCategory.value);
});
